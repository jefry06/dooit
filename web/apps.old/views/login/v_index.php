                ...
                <div class="pad20 bg222 text-white">
                    ...
                    <form method="post" action="redeem">
                        ...
                        <div class="input-group">
                            ...
                            <input id="codepluscard" name="codepluscard"  type="text" class="form-control" placeholder="0000-0000-0000-00" aria-describedby="sizing-addon2">
				...
				<div class="modal-body">
					<div class="col-md-6">
						...
						<ol>
							...
							<li>Masukkan Kode PlusCard yang tertera pada kartu dan tekan tombol “Redeem”.</li>
					...
					<div class="col-md-6">
						...
						<ol>
							...
							<li>Login ke dalam portal PlusCard dengan Akun Eksisting. </li>
							<li>Plilh menu “Redeem Kartu”, masukkan Kode PlusCard yang tertera pada kartu dan tekan tombol “Redeem”. </li>
                ...
                <div class="modal-body text-left">
                    ...
                    <form method="get" action="#">
						<div class="input-group">
                            ...
                            <input name="handphone"  type="text" class="form-control" placeholder="Masukan Nomor HP terdaftar" aria-describedby="sizing-addon2">
                        </div>                    
                        <div class="input-group">
                            <span class="input-group-addon" id="sizing-addon2" style="width:42px">@</span>
                            <input name="email"  type="text" class="form-control" placeholder="Masukan Email terdaftar" aria-describedby="sizing-addon2">
                        </div><br>
