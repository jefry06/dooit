    ...
    */
    ...
    var dataTable = $("#dataTable1").dataTable({
        ...
        "columns": [
          { "data": "com_code"},
          { "data": "com_name" },
          { "data": "com_domain", "sClass": "hidden-xs" },
          { "data": function ( data, type, full, meta ) {
            var ret="<img src='" + data.com_asset_url + "/img/" + data.com_logo + "' width='60' >";
             return ret;

          }, "sClass": "hidden-xs" },
          { "data" : function ( data, type, full, meta ) {
            
                    var ret='<div class="btn-group"><a class="btn btn-primary" href="#"><i class="fa fa-user fa-fw"></i> Action</a><a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#"><span class="fa fa-caret-down"></span></a><ul class="dropdown-menu"><li><a href="edit/'+data.com_id+'"><i class="fa fa-pencil fa-fw"></i> Edit</a></li><li><a href="#" onclick="delete_id('+ data.com_id +');"><i class="fa fa-trash-o fa-fw"></i> Delete</a></li></ul></div>'; 
                        return ret;
                      }            
          }
        ],  
